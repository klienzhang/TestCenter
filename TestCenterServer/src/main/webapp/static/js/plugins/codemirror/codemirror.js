...
(function(mod) {
  ...
  // "line", "div" (display.lineDiv), "local"/null (editor), or "component".
  ...
  // Context may be "window", "component", "div", or "local"/null.
  function fromCoordSystem(cm, coords, context) {
    if (context == "div") return coords;
    var left = coords.left, top = coords.top;
    // First move into "component" coordinate system
    if (context == "page") {
      left -= pageScrollX();
      top -= pageScrollY();
  ...
  // "component" or "line". The resulting position will have a hitSide=true
  // property if it reached the end of the document.
